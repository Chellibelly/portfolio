    ...
    <Box>
      ...
      <Grid container sx={{ height: "90vh", p: 10 }}>
        ...
        <Box>
          ...
          <Box sx={padText}>
            <Typography sx={{...globalStyles.heading4, mt: 10}}>
              Making Digital Checkout More Resilient
            </Typography>
            <Typography sx={{...globalStyles.paragraph}}>
              <b>Problem</b><br/><br/>
              Store associates helped customers complete digital checkout by directing them to a website where the customer would enter a unique access code.
              However, the associate interface implied that the primary way to start the process was by texting a link to the customer. 
              <br/><br/>When texting failed due to system outages, customers having difficulty with SMS, or customers not owning smartphones, associates often believed they were unable to complete checkout.
              This misunderstanding led to regular support tickets from stores reporting they were unable to check out customers.
            </Typography>      
            <Typography sx={{...globalStyles.paragraph}}>
              <b>Design Solution</b><br/><br/>
              I redesigned the associate homepage to reframe the task and surface multiple entry options clearly. With new framing, I shifted the message from “send a text” to “help the customer access the site.” Three clearly labeled options were introduced, each with a visual illustration. These options help associates quickly understand they have multiple paths to success, reducing reliance on SMS.
            </Typography>  
            <Typography sx={{...globalStyles.paragraph}}>
              <b>Impact</b><br/><br/>
              After the redesign was released, support tickets related to checkout access dropped from 1–2 per week to zero. Store associates were able to complete transactions even when SMS was unavailable because the interface clearly presented multiple ways for customers to access the site. By reframing the instructions and making alternative paths visible, the redesign eliminated a recurring operational issue without requiring backend changes or additional training.
            </Typography> 
          </Box>
          <Grid container justifyContent="center" alignItems="center" sx={{ mt: 10 }}>
            <Grid item xs={10} sx={{mr: 5 }}>
              <Image
                src={DigitalCheckoutOptions}
                alt="Digital Checkout Options"
                style={{ margin: "auto", borderTopLeftRadius: 4, borderTopRightRadius: 4, width: 2000 }}
              />
            </Grid>
