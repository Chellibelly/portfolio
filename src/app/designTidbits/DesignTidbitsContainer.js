...
const DesignTidbitsContainer = () => {
  return (
    <Box>
      <Header/>
      <Grid container sx={{ height: "90vh", p: 8 }}>
        <Box sx={{ mt: 5 }}>
        ...
        <Box sx={{ mt: 5 }}>
          ...
          <Typography sx={globalStyles.paragraph}>
            The autopay system was previously explained through dense paragraphs filled with dates, numbers, and fine print, which overwhelmed users and hid important details. I restructured this into a visually segmented interface with clearly separated sections, supported by icons and simple graphics to illustrate each payment option and its effects. This redesign helped users scan and understand their choices faster, reducing support calls and boosting confidence in autopay enrollment.
          </Typography>
          <Typography sx={{...globalStyles.paragraph, color: "red"}}>
            [Image placeholder: Before and after comparison of autopay options page]
          </Typography>
          <Typography sx={globalStyles.heading4}>
            Customer Verification
          </Typography>
          <Typography sx={globalStyles.paragraph}>
            Within the Order Hub, customer verification involved a multi-step process requiring store managers to collect and validate various documents. The original interface lumped all the requirements and instructions into lengthy paragraphs, which led to users missing steps or making incorrect approval decisions. I transformed this process into a clear, step-by-step flow, visually separating each verification task with concise action points, examples of acceptable documents, and inline validation statuses. This clarity improved compliance and reduced errors significantly.
          </Typography>
          <Typography sx={{...globalStyles.paragraph, color: "red"}}>
            [Image placeholder: Before and after screenshots of customer verification workflow]
          </Typography>
          <Typography sx={globalStyles.heading4}>
        ...
        <Box sx={{ mt: 5 }}>
          ...
          <Typography sx={globalStyles.paragraph}>
            Since its rollout, Order Hub has improved deal closure rates and customer follow-up consistency, helping managers prioritize leads and provide more personalized service. Initial metrics suggest a 20% increase in deal closure efficiency and a 15% reduction in customer follow-up delays, with user satisfaction scores climbing steadily as feedback cycles continue. The system’s scalability supports growing sales volume and ongoing feature enhancements.
          </Typography>
          <Typography sx={{...globalStyles.paragraph, color: "red"}}>
