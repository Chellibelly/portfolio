          ...
          <Paper sx={cardStyleNavigate}>
            <Grid container direction="column" justifyContent="center" alignItems="center">
              ...
              <Grid item sx={{ p: 2 }}>
                ...
                <h2 style={{ ...globalStyles.heading6, fontSize: 14, textAlign: "center", fontStyle: "italic" }}>Selected Industry Work demonstrating design of impactful <b>shipped real-world user-facing features</b> and cross-functional collaboration</h2>
              </Grid>
            </Grid>   
          </Paper>
        </Link>
