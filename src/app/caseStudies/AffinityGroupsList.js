  ...
  return (
      <Box sx={{ width: "100%", borderRadius: 3 }}>
        ...
        <Grid container direction="row" sx={{ width: "100%", marginTop: "7px" }}>
            ...
            <Grid item xs={0.1}/>
            <Grid item xs={9.9} sx={{ padding: 4, backgroundColor: blue[50] }}>
                <Typography sx={{ fontFamily: "Montserrat" }}>Users prefer a single calendar picker for selecting dates—something familiar, fast, intuitive, and easy to use, with an option to clear dates easily.</Typography>
            </Grid>
        </Grid>
