...
import SurveyQuotesPainpointsMobile from "../../../public/Survey_quotes_painpoints_Mobile.png";
import SurveyQuotesMobile from "../../../public/Survey_Quotes_Mobile.png";
...
export default function ResearchMobile() {
  return (
    ...
    <Grid item xs={12}>
      <Image
        className='graphic'
        src={SurveyQuotesPainpointsMobile}
        width="100%"
        height={500}
    ...
    <Grid item xs={10} sx={{ marginBottom: 5 }}>
      ...
      <Typography variant='body1' className='paragraph'>After each depth interview concluded, it was time for the exciting part – testing the usability of the websites. Each participant was tasked with booking a hotel in a specified city for a weekend on two different sites – two of the sites I examined during my benchmark research. I observed their actions, reminded them to think aloud if they became quiet, and asked follow-up questions when needed, being as careful as possible not to bias the tests.</Typography>
      <Typography variant='body1' className='paragraph'>Each session lasted about an hour. At the end of the tasks, I asked participants about their experience, including their overall sentiment, what differed from their expectations, what they liked or disliked, and anything they felt was missing. Finally, I expressed gratitude, thanking them for their time and participation and reiterating how useful their insight is to my research.</Typography>
    ...
    <Grid item xs={10} sx={{ marginBottom: -5 }}>
      ...
      <Typography variant='body1' className='paragraph'>Watching people struggle is painful, but important. Not everyone works through problems in the same way, and completing the task isn’t everything if the journey was painful. was nervous. I was afraid I would miss a step or overstep. I didn’t want to bias the data, but I also didn’t want my users to feel bad about themselves. With one participant, I could tell she was getting anxious and blaming herself, and it took everything I had not to jump in and console her.</Typography>
      <Typography variant='body1' className='paragraph'>Looking back, I realize I slipped a few times, and there are some things I would do differently next time. I’ll avoid agreeing with or justifying their frustrations and won’t suggest actions to fix the issue. Instead, I’ll express empathy, give them space to solve the problem, and ask them to explain what they’re feeling and trying to do when they get stuck.</Typography>
    </Grid>
  </Grid>
  );
}
