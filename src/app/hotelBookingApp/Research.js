    ...
    <Grid container justifyContent="center" spacing={4}>
      ...
      <Grid item xs={12} sm={10}>
        ...
        <Grid item xs={12} sm={10}>
          ...
          <Typography sx={globalStyles.paragraph}>
            Watching people struggle was a reminder that ability to complete tasks isn’t "a success" if the journey is <i>painful</i>. This exercise truly taught me to step back <b>observe and with empathy</b>, not control.
          </Typography>
        </Grid>
        <Grid item xs={12} sm={10}>
          <Box sx={globalStyles.graphic}>
